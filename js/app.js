...
const TRANSLATIONS = {
  cs: {
    ...
    hero_desc: "Vítejte v interaktivním trenažéru a generátoru karet Dobble pro lipidomiku. Poznávejte mastné kyseliny, fosfolipidy, sfingolipidy, steroly a hmotnostně-spektrometrické molekulární druhy!",
    hero_btn_play: "Hrát Hru",
    hero_btn_print: "Tisknout Karty",
    how_title: "Jak hra funguje?",
    feat_math_title: "Princip Dobble",
    feat_math_desc: "Základním matematickým principem hry je, že libovolné dvě karty v balíčku sdílejí přesně jeden společný prvek. Úkolem hráčů je tuto shodu najít a pojmenovat dříve než soupeři!",
    feat_meaning_title: "Párování podle významu",
    feat_meaning_desc: "Společný prvek se na kartách zobrazuje v odlišných formátech (český/anglický název, 2D strukturní vzorec s cis-konformací, 3D PyMOL model nebo zkratka code3). Trénujete reálnou chemii!",
    feat_print_title: "Flexibilní tisk a export",
    feat_print_desc: "Přizpůsobte si tvar karet (kulaté / čtvercové), rotaci symbolů, počet karet na stránku (4 až 12 karet na A4) a vytiskněte si připravený výukový balíček na papír.",
    datasets_title: "Dostupné verze balíčků a datasetů",
    ds_membrane_tag: "q = 3 (13 lipidů)",
    ds_membrane_title: "1. Membrána",
    ds_membrane_desc: "Základní sada výukového trenažéru určená pro seznámení s hlavním lipidovým složením biologických membrán a klíčovými mastnými kyselinami.",
    ds_signaling_tag: "q = 5 (31 lipidů)",
    ds_signaling_title: "2. Signalizace",
    ds_signaling_desc: "Rozšířená sada zaměřená na lipidovou signalizaci, eikosanoidy, endocanabinoidy, druhotné posly a steroidní hormony.",
    ds_atlas_tag: "q = 7 (57 lipidů)",
    ds_atlas_title: "3. LIPID MAPS Atlas",
    ds_atlas_desc: "Komplexní atlas výuky lipidomiky pokrývající všech 5 hlavních tříd lipidů (FA, GP, SP, ST, GL) a vitamíny rozpustné v tucích.",
    ds_massspec_tag: "q = 8 (73 druhů)",
    ds_massspec_title: "4. Mass Spec Nightmare",
    ds_massspec_desc: "Expertní sada určená pro pokročilé studenty a analytiky hmotnostní spektrometrie obsahující konkrétní molekulární druhy lipidů.",
    ds_includes: "Klíčové molekuly:",
  ...
  en: {
    ...
    how_title: "How the Game Works",
    feat_math_title: "Dobble Principle",
    feat_math_desc: "The fundamental mathematical rule is that any two cards in the deck share exactly one matching item. Find and call out the match before your opponents!",
    feat_meaning_title: "Meaning-Based Matching",
    feat_meaning_desc: "Matching items appear in different formats (local/English name, 2D structural formula with cis-conformations, 3D PyMOL model, or code3 abbreviation). Practice real chemistry!",
    feat_print_title: "Flexible Printing & Export",
    feat_print_desc: "Customize card shape (circular or square), symbol rotation, grid layout (4 to 12 cards per A4 page), and export a print-ready deck.",
    datasets_title: "Available Decks & Datasets",
    ds_membrane_tag: "q = 3 (13 lipids)",
    ds_membrane_title: "1. Membrane",
    ds_membrane_desc: "Entry-level training deck covering primary biological membrane lipids and core fatty acids.",
    ds_signaling_tag: "q = 5 (31 lipids)",
    ds_signaling_title: "2. Signaling",
    ds_signaling_desc: "Expanded deck focused on lipid signaling, eicosanoids, endocannabinoids, second messengers, and steroid hormones.",
    ds_atlas_tag: "q = 7 (57 lipids)",
    ds_atlas_title: "3. LIPID MAPS Atlas",
    ds_atlas_desc: "Comprehensive lipidomics atlas spanning all 5 major lipid categories (FA, GP, SP, ST, GL) and fat-soluble vitamins.",
    ds_massspec_tag: "q = 8 (73 species)",
    ds_massspec_title: "4. Mass Spec Nightmare",
    ds_massspec_desc: "Expert-level dataset designed for mass spectrometry analytical practice with specific molecular lipid species.",
    ds_includes: "Key molecules:",
  ...
  de: {
    ...
    feat_math_title: "Dobble-Prinzip",
    feat_math_desc: "Zwei beliebige Karten im Deck haben genau ein gemeinsames Symbol. Finden Sie das passende Lipid vor Ihren Mitspielern!",
    feat_meaning_title: "Bedeutungsbasiertes Matching",
    feat_meaning_desc: "Das gemeinsame Symbol erscheint in unterschiedlichen Formaten (Name, 2D-Strukturformel mit cis-Konformation, 3D-Modell oder Code3).",
    feat_print_title: "Drucken & Export",
    feat_print_desc: "Passen Sie Kartenform (rund/quadratisch), Drehung und Layout an (4 bis 12 Karten pro A4-Seite).",
    datasets_title: "Verfügbare Decks & Datensätze",
    ds_membrane_tag: "q = 3 (13 Lipide)",
    ds_membrane_title: "1. Membran",
    ds_membrane_desc: "Einsteigersatz für biologische Membranlipide und wichtige Fettsäuren.",
    ds_signaling_tag: "q = 5 (31 Lipide)",
    ds_signaling_title: "2. Signalwege",
    ds_signaling_desc: "Fokussiert auf Lipidsignalwege, Eicosanoide, Endocannabinoide und Steroidhormone.",
    ds_atlas_tag: "q = 7 (57 Lipide)",
    ds_atlas_title: "3. LIPID MAPS Atlas",
    ds_atlas_desc: "Umfassender Atlas aller 5 Hauptklassen von Lipiden und fettlöslichen Vitaminen.",
    ds_massspec_tag: "q = 8 (73 Arten)",
    ds_massspec_title: "4. Mass Spec Nightmare",
    ds_massspec_desc: "Expertensatz für Massenspektrometrie mit spezifischen Molekülspezies.",
    ds_includes: "Wichtige Moleküle:",
  ...
  fr: {
    ...
    feat_math_title: "Principe de Dobble",
    feat_math_desc: "Deux cartes du paquet partagent exactement un élément commun. Trouvez la correspondance avant vos adversaires !",
    feat_meaning_title: "Appariement par le sens",
    feat_meaning_desc: "Le symbole commun apparaît sous des formes différentes (nom, formule 2D avec conformation cis, modèle 3D ou code3).",
    feat_print_title: "Impression et export",
    feat_print_desc: "Personnalisez la forme des cartes, la rotation et la disposition sur page A4 (4 à 12 cartes).",
    datasets_title: "Jeux de données disponibles",
    ds_membrane_tag: "q = 3 (13 lipides)",
    ds_membrane_title: "1. Membrane",
    ds_membrane_desc: "Jeu de base pour s'initier aux lipides membranaires et acides gras principaux.",
    ds_signaling_tag: "q = 5 (31 lipides)",
    ds_signaling_title: "2. Signalisation",
    ds_signaling_desc: "Axé sur la signalisation lipidique, les eicosanoïdes et hormones stéroïdes.",
    ds_atlas_tag: "q = 7 (57 lipides)",
    ds_atlas_title: "3. LIPID MAPS Atlas",
    ds_atlas_desc: "Atlas complet des 5 catégories majeures de lipides et vitamines liposolubles.",
    ds_massspec_tag: "q = 8 (73 espèces)",
    ds_massspec_title: "4. Mass Spec Nightmare",
    ds_massspec_desc: "Jeu expert pour la spectrométrie de masse avec des espèces moléculaires précises.",
    ds_includes: "Molécules clés :",
